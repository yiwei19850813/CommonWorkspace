...
#define MIN_POPUPVIEW_WIDTH 20.0
#define MIN_POPUPVIEW_HEIGHT 20.0
#define POPUPVIEW_WIDTH_INSET 5.0
...
- (void)layoutSubviews
{
    ...
    if (!CGSizeEqualToSize(self.bounds.size, _oldSize)) {
        ...
        NSAttributedString *tempStr = _textLayer.string;
        CGFloat textHeight = [tempStr size].height;
